...
public class Connect5_copy extends JFrame implements ActionListener{
	...
	//Button Icon Source 
	static ImageIcon emptyButton = new ImageIcon(Connect5_copy.class.getResource("/resources/emptycoin.png"));
	static ImageIcon redButton = new ImageIcon(Connect5_copy.class.getResource("/resources/red coin v2.png"));
	static ImageIcon yellowButton = new ImageIcon(Connect5_copy.class.getResource("/resources/yellow coin v2.png"));

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		myframe = new Connect5_copy();
		//myframe.setLayout();
