...
public class Storage {
	...
	public static void saveIncrementStatus() {//Gets the latest number of the file so that it can make a new file .the next one in order.even if you close the program
		
		String dir_name = AdditionalStuff.dir_Desktop + "\\Connect5Save"; 
	...
	public static void save() throws IOException 
	{
		...
		FileWriter writehandle = new FileWriter(AdditionalStuff.dir_Desktop+"\\Connect5Save\\Connect5save "+StoGamNum+".txt",true);
		...
		} catch (Exception e) 
	{
		...
		JOptionPane.showMessageDialog(errorFrame,"\nGame has no playes to be saved","Error",JOptionPane.ERROR_MESSAGE);
		}
	...
	public static void load(int returnVal) throws IOException
	{
		...
		//file chooser helps to select the file i want to load
